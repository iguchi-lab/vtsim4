...
・solve：連立方程式の解法を選択します。省略した場合はLU分解法が採用されます。LU分解法の場合、 0 または vt.solve_LU、SOR法の場合、 1 または vt.solve_SOR を設定します。
...
vtsimの出力設定です。pandas.DataFrame のみの出力の場合 vt.OPT_DF または 0 、さらにcsvファイルを出力する場合 vt.OPT_CSV または 1、加えてグラフを出力する場合 vt.OPT_GRAPH または 2を設定します。
